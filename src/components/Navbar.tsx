...
const Navbar = () => {
    ...
    return (
        <nav className={`bg-none px-5 xl:px-32 2xl:px-96 py-4 fixed top-0 left-0 w-full z-50 transition-transform duration-300 ${showNavbar ? "translate-y-0" : "-translate-y-full"}`}>
